 ...
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * | Ctrl |      | Lower| Alt  | Meta | Space|    | ENTER| Meta | Alt  | RAISE|      |      |
 * `-----------------------------------------'    `-----------------------------------------'
 */
    [_QW] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL , _______, LOWER, KC_LALT, KC_LGUI, KC_SPC, KC_ENT , KC_LGUI, KC_RALT, RAISE, _______, _______
        ),
 ...
 * |  `   |  !   |  @   |  #   |  $   |  %   |    |  ^   |  &   | *    |     |  (   |  )    |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |      | Vol+ | Mute | Play | PgUp | Ins  |    |  Left|  Down|  Up  | Right|  {   |  }   |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |      | Vol- | < M  |  M > | PgDn |      |    | Home |PgDown| PgUp |      |  [   |  ]   |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |      |      |      |      |LOWER |      |    | Shift|Adjust|      |      |      |      |
 * `-----------------------------------------'    `-----------------------------------------'
 */
    [_LW] = LAYOUT_ortho_4x12(
        ...
        _______ , KC_VOLU, KC_MUTE, KC_MPLY, KC_PGUP, KC_INS ,    KC_LEFT , KC_DOWN, KC_UP  , KC_RIGHT, KC_LCBR, KC_RCBR,
        _______ , KC_VOLD, KC_MPRV, KC_MNXT, KC_PGDN, _______,    KC_HOME , KC_PGDN, KC_PGUP, _______, KC_LBRC, KC_RBRC ,
